...
?>
<body>
		<form class="login" name="std_form" method="POST" enctype="multipart/form-data"  action="personal_info_form_controller.php?type=std">
		...
		<div class="page-header"><h3>Family Details</h3></div>
		<h4>Father's Name:</h4>
		<div class="row">
		...
		<br />
		<div class="page-header"><h3>In case of Emergency, contact on following details:</h3></div>
		<div class="row">
