		  ...
		  <table class="table table-hover text-center">
	    	...
	    	?>
		    	<tr>
		    		...
		    		<td><a href="std_info.php?id=<?php echo $row['personal_id'];?>" class="btn btn-info" type="button">Details</a></td>
		    		<?php }else{?>
		    		<td><a href="staff_info.php?id=<?php echo $row['personal_id'];?>" class="btn btn-info" type="button">Details</a></td>
		    		<?php } ?>
